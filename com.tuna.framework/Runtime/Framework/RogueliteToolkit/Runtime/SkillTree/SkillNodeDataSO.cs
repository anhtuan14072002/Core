...
namespace RogueliteToolkit.SkillTree
{
    ...
    public enum SkillNodeColor { Blue = 0, Purple = 1, Red = 2, Gold = 3 }
    ...
    public sealed class SkillNodeDataSO : ScriptableObject
    {
        ...
        [SerializeField, Tooltip("Click to upgrade one level for free without opening the upgrade popup.")] private bool _instantFreeUpgrade;
        ...
        public bool InstantFreeUpgrade => _instantFreeUpgrade;
        public SkillNodeColor NodeColor => _nodeColor;
        ...
        public IReadOnlyList<SkillResourceCost> AdditionalCosts => _additionalCosts;
        public IReadOnlyList<double> Costs => _costs ?? Array.Empty<double>();
        ...
        public void CopyFrom(SkillNodeDefinition source)
        {
            ...
            _icon = source.Icon;
            _instantFreeUpgrade = source.InstantFreeUpgrade;
            _nodeColor = source.NodeColor;
            ...
            _additionalCosts = source.AdditionalCosts.ToArray();
