    ...
    public sealed class SkillNodeAuthoring : MonoBehaviour
    {
        ...
        public void SetData(SkillNodeDataSO data)
        {
            if (data == null && _data != null)
            {
                ...
                _id = Id; _displayName = DisplayName; _description = Description;
                _icon = Icon; _color = Color; _maxLevel = LevelsPerPhase; _phaseCount = PhaseCount;
                ...
                _costs = CopyCosts(); _statEffects = CopyStatEffects(); _effects = CopyEffects();
            }
            _data = data;
        }
        ...
        public int[] CopyCosts() => Costs.ToArray();
