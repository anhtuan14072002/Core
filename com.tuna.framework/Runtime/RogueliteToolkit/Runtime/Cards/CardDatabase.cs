...
namespace RogueliteToolkit.Cards
{
    ...
    public sealed class CardDatabase : ScriptableObject
    {
        ...
        [Header("Card Visuals")]
        [SerializeField] private CardRarityVisualStyle[] _rarityVisualStyles =
            Array.Empty<CardRarityVisualStyle>();
        [Tooltip("Allow cards already selected by the player to appear again while below Max Stacks.")]
        [SerializeField] private bool _allowSelectedCards = true;
